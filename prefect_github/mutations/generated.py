...
@task(name="mutations.add_comment_subject")
...
@task(name="mutations.create_pull_request")
...
@task(name="mutations.close_pull_request")
...
@task(name="mutations.create_issue")
...
@task(name="mutations.close_issue")
...
@task(name="mutations.add_star_starrable")
...
@task(name="mutations.remove_star_starrable")
...
@task(name="mutations.add_reaction_subject")
...
@task(name="mutations.add_reaction")
...
@task(name="mutations.remove_reaction_subject")
...
@task(name="mutations.remove_reaction")
...
@task(name="mutations.request_reviews")
...
@task(name="mutations.request_reviews_pull_request")
...
@task(name="mutations.add_pull_request_review")
