...
@task(name="repository_owner.query_repository_owner")
...
@task(name="repository_owner.query_repository_owner_repository")
...
@task(name="repository_owner.query_repository_owner_repositories")
