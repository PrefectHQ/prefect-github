...
class StartRepositoryMigrationInput(sgqlc.types.Input):
    __schema__ = graphql_schema
    __field_names__ = ('source_id', 'owner_id', 'source_repository_url', 'repository_name', 'continue_on_error', 'git_archive_url', 'metadata_archive_url', 'access_token', 'github_pat', 'skip_releases', 'client_mutation_id')
    source_id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='sourceId')
    owner_id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='ownerId')
...
class EnterpriseBillingInfo(sgqlc.types.Type):
    __schema__ = graphql_schema
    __field_names__ = ('all_licensable_users_count', 'asset_packs', 'available_seats', 'bandwidth_quota', 'bandwidth_usage', 'bandwidth_usage_percentage', 'seats', 'storage_quota', 'storage_usage', 'storage_usage_percentage', 'total_available_licenses', 'total_licenses')
    ...
    available_seats = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='availableSeats')
...
class Mutation(sgqlc.types.Type):
    ...
    add_project_draft_issue = sgqlc.types.Field(AddProjectDraftIssuePayload, graphql_name='addProjectDraftIssue', args=sgqlc.types.ArgDict((
    ...
    update_project_draft_issue = sgqlc.types.Field('UpdateProjectDraftIssuePayload', graphql_name='updateProjectDraftIssue', args=sgqlc.types.ArgDict((
...
class ReactionGroup(sgqlc.types.Type):
    __schema__ = graphql_schema
    __field_names__ = ('content', 'created_at', 'reactors', 'subject', 'users', 'viewer_has_reacted')
    content = sgqlc.types.Field(sgqlc.types.non_null(ReactionContent), graphql_name='content')
...
class TreeEntry(sgqlc.types.Type):
    __schema__ = graphql_schema
    __field_names__ = ('extension', 'is_generated', 'line_count', 'mode', 'name', 'object', 'oid', 'path', 'repository', 'submodule', 'type')
    extension = sgqlc.types.Field(String, graphql_name='extension')
...
class BranchProtectionRule(sgqlc.types.Type, Node):
    __schema__ = graphql_schema
    __field_names__ = ('allows_deletions', 'allows_force_pushes', 'blocks_creations', 'branch_protection_rule_conflicts', 'bypass_force_push_allowances', 'bypass_pull_request_allowances', 'creator', 'database_id', 'dismisses_stale_reviews', 'is_admin_enforced', 'matching_refs', 'pattern', 'push_allowances', 'repository', 'required_approving_review_count', 'required_status_check_contexts', 'required_status_checks', 'requires_approving_reviews', 'requires_code_owner_reviews', 'requires_commit_signatures', 'requires_conversation_resolution', 'requires_linear_history', 'requires_status_checks', 'requires_strict_status_checks', 'restricts_pushes', 'restricts_review_dismissals', 'review_dismissal_allowances')
    allows_deletions = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='allowsDeletions')
    allows_force_pushes = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='allowsForcePushes')
    blocks_creations = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='blocksCreations')
...
class Sponsorship(sgqlc.types.Type, Node):
    __schema__ = graphql_schema
    __field_names__ = ('created_at', 'is_one_time_payment', 'is_sponsor_opted_into_email', 'maintainer', 'privacy_level', 'sponsor', 'sponsor_entity', 'sponsorable', 'tier', 'tier_selected_at')
    created_at = sgqlc.types.Field(sgqlc.types.non_null(DateTime), graphql_name='createdAt')
