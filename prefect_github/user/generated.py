...
@task(name="user.query_user_gist")
...
@task(name="user.query_user_gists")
...
@task(name="user.query_user_issues")
...
@task(name="user.query_user_status")
...
@task(name="user.query_user_project")
...
@task(name="user.query_user_packages")
...
@task(name="user.query_user_projects")
...
@task(name="user.query_user_sponsors")
...
@task(name="user.query_user_watching")
...
@task(name="user.query_user_project_v2")
...
@task(name="user.query_user_followers")
...
@task(name="user.query_user_following")
...
@task(name="user.query_user_projects_v2")
...
@task(name="user.query_user_repository")
...
@task(name="user.query_user_sponsoring")
...
@task(name="user.query_user_public_keys")
...
@task(name="user.query_user_project_next")
...
@task(name="user.query_user_pinned_items")
...
@task(name="user.query_user_projects_next")
...
@task(name="user.query_user_repositories")
...
@task(name="user.query_user_item_showcase")
...
@task(name="user.query_user_gist_comments")
...
@task(name="user.query_user_organization")
...
@task(name="user.query_user_pull_requests")
...
@task(name="user.query_user_saved_replies")
...
@task(name="user.query_user_pinnable_items")
...
@task(name="user.query_user_issue_comments")
...
@task(name="user.query_user_organizations")
...
@task(name="user.query_user_recent_projects")
...
@task(name="user.query_user_commit_comments")
...
@task(name="user.query_user_sponsors_listing")
...
@task(name="user.query_user_top_repositories")
...
@task(name="user.query_user_sponsors_activities")
...
@task(name="user.query_user_interaction_ability")
...
@task(name="user.query_user_starred_repositories")
...
@task(name="user.query_user_repository_discussions")
...
@task(name="user.query_user_sponsorships_as_sponsor")
...
@task(name="user.query_user_sponsorship_newsletters")
...
@task(name="user.query_user_contributions_collection")
...
@task(name="user.query_user_sponsorships_as_maintainer")
...
@task(name="user.query_user_repositories_contributed_to")
...
@task(name="user.query_user_repository_discussion_comments")
...
@task(name="user.query_user_sponsorship_for_viewer_as_sponsor")
...
@task(name="user.query_user_sponsorship_for_viewer_as_sponsorable")
