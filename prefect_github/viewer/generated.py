...
config_path = (
    Path(__file__).parent.resolve() / ".." / "configs" / "query" / "viewer.json"
)
return_fields_defaults = initialize_return_fields_defaults(config_path)


@task(name="viewer.query_viewer")
...
@task(name="viewer.query_viewer_gist")
...
@task(name="viewer.query_viewer_gists")
...
@task(name="viewer.query_viewer_issues")
...
@task(name="viewer.query_viewer_status")
...
@task(name="viewer.query_viewer_project")
...
@task(name="viewer.query_viewer_packages")
...
@task(name="viewer.query_viewer_projects")
...
@task(name="viewer.query_viewer_sponsors")
...
@task(name="viewer.query_viewer_watching")
...
@task(name="viewer.query_viewer_project_v2")
...
@task(name="viewer.query_viewer_followers")
...
@task(name="viewer.query_viewer_following")
...
@task(name="viewer.query_viewer_projects_v2")
...
@task(name="viewer.query_viewer_repository")
...
@task(name="viewer.query_viewer_sponsoring")
...
@task(name="viewer.query_viewer_public_keys")
...
@task(name="viewer.query_viewer_project_next")
...
@task(name="viewer.query_viewer_pinned_items")
...
@task(name="viewer.query_viewer_projects_next")
...
@task(name="viewer.query_viewer_repositories")
...
@task(name="viewer.query_viewer_item_showcase")
...
@task(name="viewer.query_viewer_gist_comments")
...
@task(name="viewer.query_viewer_organization")
...
@task(name="viewer.query_viewer_pull_requests")
...
@task(name="viewer.query_viewer_saved_replies")
...
@task(name="viewer.query_viewer_pinnable_items")
...
@task(name="viewer.query_viewer_issue_comments")
...
@task(name="viewer.query_viewer_organizations")
...
@task(name="viewer.query_viewer_recent_projects")
...
@task(name="viewer.query_viewer_commit_comments")
...
@task(name="viewer.query_viewer_sponsors_listing")
...
@task(name="viewer.query_viewer_top_repositories")
...
@task(name="viewer.query_viewer_sponsors_activities")
...
@task(name="viewer.query_viewer_interaction_ability")
...
@task(name="viewer.query_viewer_starred_repositories")
...
@task(name="viewer.query_viewer_repository_discussions")
...
@task(name="viewer.query_viewer_sponsorships_as_sponsor")
...
@task(name="viewer.query_viewer_sponsorship_newsletters")
...
@task(name="viewer.query_viewer_contributions_collection")
...
@task(name="viewer.query_viewer_sponsorships_as_maintainer")
...
@task(name="viewer.query_viewer_repositories_contributed_to")
...
@task(name="viewer.query_viewer_repository_discussion_comments")
...
@task(name="viewer.query_viewer_sponsorship_for_viewer_as_sponsor")
...
@task(name="viewer.query_viewer_sponsorship_for_viewer_as_sponsorable")
